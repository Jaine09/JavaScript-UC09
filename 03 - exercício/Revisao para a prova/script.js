...
Se a idade for maior ou igual a 18, imprimir no console a mensagem "Pode entrar!".Caso contrário, não imprimir nada. */
/*let idade = 15;
if(idade >= 18){
...
*/
/*const num = 18
let potencia = Math.pow(2,2); //ou console.log(Math.pow(2,2));
console.log(potencia);
let potencia3 = Math.pow(3,2);
