...
if(mediaFinal >= 7){
    console.log(`O aluno ${NomeAluno} teve uma média ${mediaFinal} e foi aprovado!`)
}else if (mediaFinal >= 5){
    console.log(`O aluno ${NomeAluno} teve uma média ${mediaFinal} e está de recuperação!`)
}else{
    console.log(`O aluno ${NomeAluno} teve uma média ${mediaFinal} e foi reprovado!`)
}
